...
void gpu_spmv(double* dx ,double* b, int nrows, double* dA, int *djA,int *diA,int mattype,int blocks,int  threads);
...
__device__ void cudaDeviceVWRMS_Norm(double *g_idata1, double *g_idata2, double *odata, unsigned int n);
